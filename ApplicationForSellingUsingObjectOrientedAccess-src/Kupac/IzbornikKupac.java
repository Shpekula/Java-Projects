...
IzvjestajKupac izvjestaj = new IzvjestajKupac();
    /**
     * Creates new form IzbornikKupac
     */
    public IzbornikKupac() {
        initComponents();
        zamjeni();
    }
    ...
    private void initComponents() {
        ...
        btnAzuriranje.setText("Ažuriranje");
        btnAzuriranje.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAzuriranjeActionPerformed(evt);
            }
        });

        btnIzvjestaj.setText("Izvještaj");
        ...
        jLabel1.setText("Izbornik kupci");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(btnAzuriranje, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAzuriranjeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAzuriranjeActionPerformed
        // TODO add your handling code here:
        azuriranje.setVisible(true);
        dispose();
    }//GEN-LAST:event_btnAzuriranjeActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IzbornikKupac.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IzbornikKupac().setVisible(true);
            }
        });
    }
