 ...
 * @author Shpekula
 */
public class IzbornikPoluproizvod extends javax.swing.JFrame {

    /**
     * Creates new form IzbornikPoluproizvod
     */
    public IzbornikPoluproizvod() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnSUP.setText("Sirovine u Poluproiizvodu");
        ...
        jLabel1.setText("Izbornik Poluproizvod");

        btnPovratak.setText("Povratak naGlavni izbornik");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(btnKreirajPP, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(63, 63, 63)
    ...
    private void btnSUPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSUPActionPerformed
        ...
        KreiranjePoluproizvoda sup = new KreiranjePoluproizvoda();
        sup.setVisible(true);
        dispose();
    ...
    private void btnKreirajPPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKreirajPPActionPerformed
        // TODO add your handling code here:
        IzradaPoluproizvoda kreiranjePP = new IzradaPoluproizvoda();
        kreiranjePP.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IzbornikPoluproizvod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IzbornikPoluproizvod().setVisible(true);
            }
        });
    }
