 ...
 * @author Shpekula
 */
public class IzvjestajOSirovini extends javax.swing.JFrame {
SQLSirovine sqlsirovine = new SQLSirovine();
    /**
     * Creates new form IzvjestajOSirovini
     */
    public IzvjestajOSirovini() {
        initComponents();
        IzvjestajOSirovinama();
    }
    ...
    private void initComponents() {
        ...
        tablicaSirovina = new javax.swing.JTable();
        ...
        jLabel1.setText("Izvještaj o sirovini");

        tablicaSirovina.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Šifra sirovine", "Naziv sirovine", "Količina sirovine"
            }
        ) {
        ...
        jScrollPane1.setViewportView(tablicaSirovina);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IzvjestajOSirovini.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IzvjestajOSirovini().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tablicaSirovina;
    // End of variables declaration//GEN-END:variables
private void IzvjestajOSirovinama()
{
    DefaultTableModel model = (DefaultTableModel)tablicaSirovina.getModel();
        
        ArrayList<Sirovine> listaSirovina = sqlsirovine.listaSirovina();
        
        listaSirovina.forEach((sirovine) -> {
            int sifraSirovina = sirovine.getSifraSirovine();
            String nazivSirovina = sirovine.getNazivSirovine();
            int kolicinaSirovina = sirovine.getKolicinaSirovine();
                            
            model.addRow(new Object[]{sifraSirovina, nazivSirovina, kolicinaSirovina});
    });
}
}
